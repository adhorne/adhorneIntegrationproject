...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    Vehicle[] myVehicles = { hyundai, chevrolet };

    for (Vehicle anVehicle : myVehicles) {
      anVehicle.showMake();
      anVehicle.showSpeed();
    }
